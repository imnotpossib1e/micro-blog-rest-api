...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleUserNotFoundException (UserNotFoundException ex) { // HTTP 응답 커스터마이징
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.NOT_FOUND); // 실제 응답 부분
    }
