...
public class FollowController {
    ...
    public ResponseEntity<FollowResponseDto> follow(@RequestBody FollowRequestDto request){ // 요청 데이터 받기
        // ID 추출
    ...
    public ResponseEntity<Void> unfollow(@PathVariable Long followerId, @PathVariable Long followeeId){ // 팔로워, 팔로이 id 받기
        // 서비스 호출
    ...
    public ResponseEntity<List<FollowResponseDto>> getFollowList (@PathVariable Long followerId){ // URL에서 id 추출
        // 서비스 호출
