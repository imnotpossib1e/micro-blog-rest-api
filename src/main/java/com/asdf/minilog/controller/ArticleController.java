...
public class ArticleController {
    ...
    public ResponseEntity<ArticleResponseDto> createArticle(@RequestBody ArticleRequestDto article){ // 요청 데이터 받기
        // 작성자 ID 추출
    ...
    public ResponseEntity<ArticleResponseDto> getArticle(@PathVariable Long articleId){ // URL 경로 받기
        // 서비스 호출
    ...
    public ResponseEntity<ArticleResponseDto> updateArticle(
            @PathVariable Long articleId, @RequestBody ArticleRequestDto article){ // URL 경로, 요청 Body 받기
        // 서비스 계층 호출
    ...
    public ResponseEntity<List<ArticleResponseDto>> getArticleByUserId(@RequestParam Long authorId){ // URL에서 쿼리 파라미터 받기
        // 서비스 호출
